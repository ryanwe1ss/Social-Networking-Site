...
--
-- Name: netconnect_prod; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE netconnect_prod WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_CA.UTF-8';


ALTER DATABASE netconnect_prod OWNER TO postgres;

\connect netconnect_prod
...
--
-- Name: comment_reports fk_comment_reports_comment_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.comment_reports
    ADD CONSTRAINT fk_comment_reports_comment_id FOREIGN KEY (comment_id) REFERENCES public.post_comments(id) ON DELETE CASCADE;


--
-- Name: comment_reports fk_comment_reports_reason; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.comment_reports
    ADD CONSTRAINT fk_comment_reports_reason FOREIGN KEY (reason) REFERENCES public.report_reasons(id);


--
-- Name: comment_reports fk_comment_reports_reported_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.comment_reports
    ADD CONSTRAINT fk_comment_reports_reported_id FOREIGN KEY (reported_id) REFERENCES public.accounts(id) ON DELETE CASCADE;


--
-- Name: comment_reports fk_comment_reports_reporter_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.comment_reports
    ADD CONSTRAINT fk_comment_reports_reporter_id FOREIGN KEY (reporter_id) REFERENCES public.accounts(id) ON DELETE CASCADE;
